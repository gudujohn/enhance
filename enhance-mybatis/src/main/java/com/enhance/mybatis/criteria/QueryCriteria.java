...
import com.enhance.mybatis.criteria.criterion.Criterion;
...
public class QueryCriteria implements Serializable, SqlConst {
	...
	public QueryCriteria add(QueryCriteria queryCriteria) {
		if (null != queryCriteria && Detect.notEmpty(queryCriteria.getCriteria())) {
	 ...
	 * 
	 * @param propertyName
	 * @param type         Ordering.DESC or Ordering.ASC
	 * @return
	 */
