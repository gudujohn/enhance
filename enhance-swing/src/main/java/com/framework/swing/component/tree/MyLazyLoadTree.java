package com.framework.swing.component.tree;
...
import com.framework.swing.component.tree.node.LoadingTreeNode;
...
public class MyLazyLoadTree extends JTree {
	 ...
	 * @return
	 */
	private long loadingNode(final MyTreeNode expandNode) {
		// 本次异步加载的处理时长
		long handleTime = 0L;
		// 开始处理的时刻
