...
public class DateDocument extends PlainDocument {
	...
	/******************************************************************
	 ** 函数名称：DateDocument 功能描述：设置此文本框显示的默认值、格式限制和当前日期 入口参数： tc :
	 * JTextComponent类型,当前操作的文本框 dateFormat : SimpleDateFormat类型,当前操作文本框的格式限制
	 * initDateTime : String类型,当前日期 返回值：无 调用者：类JDateDocument
	 *******************************************************************/
	 ...
	 * 入口参数：offset: int型,插入位置 s: String型,插入字符串 attributeSet: AttributeSet型,属性集
	 * 返回值：无 调用者：类JDateDocument
	 *******************************************************************/
	@Override
	 ...
	 * BadLocationException 功能描述：重载原方法,删除合适位置的字符串 入口参数：offset: int型,插入位置 length:
	 * int型,删除长度 返回值：无 调用者：insertString(int, String,AttributeSet)
	 ***********************************************************************************/
	@Override
	...
	/**********************************************************************************
	 ** 函数名称：public boolean isLegalDate(String strDate) 功能描述：判断插入的长度为10的字符串是否合法
	 * 入口参数：intY: int型,年的值 intM: int型,月的值 intD: int型,日的值
	 * 返回值：boolean型,真,表示是合法的,假,表示不合法 调用者：insertString(int, String,AttributeSet)
	 ***********************************************************************************/
