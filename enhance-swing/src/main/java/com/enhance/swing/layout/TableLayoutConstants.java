...
public interface TableLayoutConstants {
	...
	/**
	 * Indicates that the component is leading justified in its cell. Leading justification means components are left justified if their container is left-oriented and right justified if their
	 * container is right-oriented. Trailing justification is opposite. see java.awt.Component#getComponentOrientation
	 */
	public static final int LEADING = 4;

	/**
	 * Indicates that the component is trailing justified in its cell. Trailing justification means components are right justified if their container is left-oriented and left justified if their
	 * container is right-oriented. Leading justification is opposite. see java.awt.Component#getComponentOrientation
	 */
