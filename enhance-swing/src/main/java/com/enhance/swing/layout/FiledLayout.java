...
public class FiledLayout implements LayoutManager, Serializable {

	private static final long serialVersionUID = 6741933980524179741L;
	...
	/** Constructs an instance of FiledLayout that will align components in a column using the default gap and LEFT justification. */
	public FiledLayout() {
		this(COLUMN, LEFT, DEFAULT_GAP);
	}

	/**
	 * Constructs an instance of FiledLayout using the default gap and LEFT or TOP justification.
	 * 
	...
	public void layoutContainer(Container container) {
		...
		} else {// Components arranged in a row
			// Add each component
			for (int counter = 0; counter < component.length; counter++) {
				// Use preferred size of component
				Dimension d = component[counter].getPreferredSize();
	...
	/**
	 * Determines the preferred size of the container argument using this layout. The preferred size is the smallest size that, if used for the container's size, will ensure that no component is
	...
	/**
	 * Determines the minimum size of the container argument using this layout. The minimum size is the smallest size that, if used for the container's size, will ensure that no component is
