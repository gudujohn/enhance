package com.enhance.swing.combobox;
...
import com.enhance.swing.combobox.support.checkbox.ComboCheckBoxEntry;
import com.enhance.swing.combobox.support.checkbox.ComboCheckPopUp;
import com.enhance.swing.combobox.util.ComboboxUiUtil;
...
public class CheckBoxCombobox extends JComboBox<Object> {
	...
	/**
	 * 该userObject是否已经存在下拉列表里了 如果UserObject为Model. 则比较Model.getId是否相等 其他情况直接用userObject.equals()方法进行比较
	 * 
	 * @param userObject
