...
public class TableLayoutConstraints implements TableLayoutConstants {
	 ...
	 *                    justification" or "column 1, row 1, column 2, row 2" or
	 *                    "column 1, row 1, column 2, row 2, horizontal
	 *                    justification, vertical justification". It is also
	 *                    acceptable to delimit the paramters with spaces instead of
	 *                    commas.
	 */
